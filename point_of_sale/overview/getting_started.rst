...
It is a fully integrated application that allows any transaction, 
...
.. note::
   It’s also the menu where you can edit all your point of sale settings.
...
Now, you can open your first session. From the PoS dashboard, you can
start a new session.
...
available ones appear on the left of the screen. Select the payment
...
Having a well-thought-out return policy is key to keep customers. Making
it easy for you to accept and refund those returns is, therefore, also a
key aspect of your PoS interface.
...
.. image:: media/getting_started_07.png
    :align: center
    :alt: Giving back money to customer.
...
Keeping track of your sales is key to get meaningful statistics. That’s why Odoo
